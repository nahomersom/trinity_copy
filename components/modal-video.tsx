  ...
  return (
    <div className="flex justify-center">
       ...
       */}
        ...
        <path className="bg-[#13343f] drop-shadow-2xl" d="M44 36a.999.999 0 0 0-.427-.82l-10-7A1 1 0 0 0 32 29V43a.999.999 0 0 0 1.573.82l10-7A.995.995 0 0 0 44 36V36c0 .001 0 .001 0 0Z" />
      </svg> */}
      </button>
      {/* End: Video thumbnail */}
